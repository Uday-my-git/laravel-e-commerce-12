   ...
   <div class="sidebar">
      ...
      <nav class="mt-2">
         <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
               <a href="{{ route('categories.listing') }}" class="nav-link">
                  <i class="nav-icon fas fa-file-alt"></i>
                  <p>Category</p>
               </a>
            </li>
            <li class="nav-item">
               <a href="{{ route('sub_category.listing') }}" class="nav-link">
                  <i class="nav-icon fas fa-file-alt"></i>
                  <p>Sub Category</p>
               </a>
            </li>
            <li class="nav-item">
               <a href="{{ route('brand.listing') }}" class="nav-link">
            ...
            <li class="nav-item">
               <a href="{{ route('shipping.listing') }}" class="nav-link">
                  <!-- <i class="nav-icon fas fa-tag"></i> -->
            ...
            <li class="nav-item">
               <a href="{{ route('orders.listing') }}" class="nav-link">
                  <i class="nav-icon fas fa-shopping-bag"></i>
                  <p>Orders</p>
               </a>
            </li>
            <li class="nav-item">
               <a href="{{ route('coupon.listing') }}" class="nav-link">
