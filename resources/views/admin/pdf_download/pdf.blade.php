...
<div class="invoice-container">
   <header>
      ...
      <div class="header-right company-info">
         <strong style="font-size: 13px;">E-Commerce-Business</strong><br>
   ...
   <div class="row">
      <div class="col">
         ...
         <address>
            <strong>{{ ucwords($orders->first_name) }} {{ ucwords($orders->last_name) }}</strong><br>

            {{ ucwords($orders->address) }}<br>

            {{ ucwords($orders->city) }}, {{ ucwords($orders->state) }}, {{ ucwords($orders->countriesName) }}<br>
      ...
      <div class="col">
         ...
         <div class="info-line">
            ...
            @if (!empty($orders->transaction_id))
               <b>Payment Status: </b>Online Paid (Stripe Payment) <br>
               <b>Transaction ID:</b>
               {{ $orders->transaction_id }}
            @else
               <b>Payment Status: </b>C.O.D <br>
               <b>Transaction ID:</b>
               n/a
            @endif
         </div>
